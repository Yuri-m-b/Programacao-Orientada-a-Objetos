...
Interface::Interface(QWidget *parent) : QWidget(parent)
{
    ...
    _player = new Character(80, 1, 32, "Player", ":/Outfit/Mage_Male_Full.png");
    _player->setWeapon(new Weapon(8));
    _player->setShield(new Shield(0.05));

    _monster.push_back(new Character(100,1, 12, "Rat", ":/Monsters/Rat.png"));
    _monster.push_back(new Character(100,1, 15, "Troll", ":/Monsters/Rat.png"));
    _monster.push_back(new Character(100,1, 19, "Orc", ":/Itens/bp_poi.png"));

    _monster[1]->setShield(new Shield(0.05));
    _monster[1]->setWeapon(new Weapon(10));

    _monster[2]->setShield(new Shield(0.05));
    _monster[2]->setWeapon(new Weapon(10));
    ...
    skillsAttribute * hitpoints = new skillsAttribute("Hitpoints:", _player->getLifeLevel(), true, 80);
    ...
    skillsAttribute * player_hitpoints = new skillsAttribute("Player Life:", _player->getLifeLevel(), true, 80);
    QPixmap player_outfit(":/Outfit/Mage_Male_Full.png");
  ...
  //  btn_ring->setFixedSize(40,40);
   ...
   // btn_utility->setFixedSize(40,40);
    QPixmap bpslot1_sprite(":/Itens/frozen.png");
   ...
   // btn_utility->setFixedSize(40,40);
    QPixmap bpslot2_sprite(":/Itens/frozen.png");
   ...
   // btn_utility->setFixedSize(40,40);
    QPixmap bpslot3_sprite(":/Itens/frozen.png");
   ...
   // btn_utility->setFixedSize(40,40);
    QPixmap bpslot4_sprite(":/Itens/frozen.png");
   ...
   // btn_utility->setFixedSize(40,40);
    QPixmap bpslot5_sprite(":/Itens/frozen.png");
   ...
   // btn_utility->setFixedSize(40,40);
    QPixmap bpslot6_sprite(":/Itens/frozen.png");
   ...
   // btn_utility->setFixedSize(40,40);
    QPixmap bpslot7_sprite(":/Itens/frozen.png");
   ...
   // btn_utility->setFixedSize(40,40);
    QPixmap bpslot8_sprite(":/Itens/frozen.png");
